...
namespace Infra.Migrations
{
    ...
    [Migration("20221109204841_novaTabela")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Ata", b =>
                {
                    ...
                    b.Property<DateTime>("DataVencimentoAta")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Domain.Entities.OrdemFornecimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProgramacaoConsumoParticipanteId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("ProgramacaoConsumoParticipanteId");

                    b.ToTable("OrdemFornecimento");
                });
            ...
            modelBuilder.Entity("Domain.Entities.RealinhamentoPreco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RealinhamentosPrecos", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.OrdemFornecimento", b =>
                {
                    b.HasOne("Domain.Entities.ProgramacaoConsumoParticipante", "ProgramacaoConsumoParticipante")
                        .WithMany("OrdemFornecimentos")
                        .HasForeignKey("ProgramacaoConsumoParticipanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProgramacaoConsumoParticipante");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Item", b =>
                {
                    ...
                    b.Navigation("RealinhamentosPrecos");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProgramacaoConsumoParticipante", b =>
                {
                    b.Navigation("OrdemFornecimentos");
                });
